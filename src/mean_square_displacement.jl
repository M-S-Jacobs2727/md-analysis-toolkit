...
"""
    mean_square_displacement(filenames...; max_num_frames=100, types=[], by_mol=false, masses=nothing)
...
"""
function mean_square_displacement(filenames...; max_num_frames=100, types=nothing, by_mol=false, masses=nothing)
    # Read basic info
